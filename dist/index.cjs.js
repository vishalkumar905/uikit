...
var Icon$v = function (props) {
    return (React__default['default'].createElement("div", { style: { 'marginRight': '15px' } },
        React__default['default'].createElement("img", { alt: "logo", style: { width: "35px" }, src: "/images/logo-with-circle.png" })));
};
...
var Icon$D = function (props) {
    return (React__default['default'].createElement("div", { style: { 'marginRight': '15px' } },
        React__default['default'].createElement("img", { alt: "logo", style: { width: "20px" }, src: "/images/lottery/lottary-ticket-160x160.png" })));
};
...
var SpinnerIcon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default['default'].createElement("image", { width: "96", height: "96", href: "/images/loader.gif" })));
};
...
var Icon$I = function (props) {
    return (React__default['default'].createElement("div", __assign({}, props, { style: { "marginRight": "8px" } }),
        React__default['default'].createElement("img", { style: { "width": "25px" }, src: "/images/icons/farms-60x60.png" })));
};
...
var Icon$M = function (props) {
    return (React__default['default'].createElement("div", __assign({}, props, { style: { "marginRight": "8px" } }),
        React__default['default'].createElement("img", { style: { "width": "25px" }, src: "/images/icons/home-60x60.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement("div", __assign({}, props),
        React__default['default'].createElement("img", { width: "215", src: isDark ? '/images/egg/LogoTextNewDark.png' : '/images/egg/LogoTextNewWhite.png' })));
};
...
var Icon$T = function (props) {
    return (React__default['default'].createElement("div", __assign({}, props, { style: { "marginRight": "8px" } }),
        React__default['default'].createElement("img", { style: { "width": "25px" }, src: "/images/icons/pool-60x60.png" })));
};
...
var Icon$X = function (props) {
    return (React__default['default'].createElement("div", __assign({}, props, { style: { "marginRight": "8px" } }),
        React__default['default'].createElement("img", { style: { "width": "25px" }, src: "/images/icons/trade-60x60.png" })));
};
...
var socials = [
    ...
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/milkshakeswap",
    },
];
var MENU_HEIGHT = 64;
...
var Avatar = function (_a) {
    ...
    var icon = image ? (React__default['default'].createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" })) : (React__default['default'].createElement(Icon$17, { width: "32px", height: "32px" }));
    if (isExternal) {
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#141259", textDisabled: "#BDC2C4", textSubtle: "#141259", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#141259", borderColor: "#524B63", card: "#27262c", gradients: {
